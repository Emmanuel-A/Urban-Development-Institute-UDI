...
class Widget_Template_Widget extends WP_Widget
{
...
if (!function_exists('register_widget_template_widget')):
	function register_widget_template_widget() {
		register_widget('Widget_Template_Widget');
	}
	add_action('widgets_init', 'register_widget_template_widget');
endif;
